...
// import FileHash from "./contracts/FileHash.json";
...
//------------- Front End UI Elements are Displayed by render() -----------
  render() {
    ...
    */}
    ...
    {/*  ----- STEP 2 : Add Hash of the file to Blockchain ------
    ...
    */}
    ...
    {/*  ----- STEP 3 : Retrieveing Borrower and Hash of the Note ------
        <div>
